...
public:
    ...
    class spell_dh_sigil_of_misery_fear_AuraScript : public AuraScript
    {
        ...
        bool CheckProc(ProcEventInfo& eventInfo)
        {
            ...
            if (Aura* fear = GetAura())
            {
                uint64 const dmg = fear->Variables.GetValue<uint64>("SigilOfMiseryFearDamage", 0);
...
class aura_dh_chaos_cleave : public AuraScript
{
    ...
    void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
    {
        ...
        GetTarget()->CastCustomSpell((Unit*)nullptr, SPELL_DH_CHAOS_CLEAVE_DAMAGE, &bp, nullptr, nullptr, true, nullptr, aurEff);
    }

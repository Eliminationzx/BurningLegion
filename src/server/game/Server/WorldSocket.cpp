...
uint8 const ClientTypeSeed_Win[16] = { 0x28, 0x3E, 0x8D, 0x77, 0xEC, 0xF7, 0x06, 0x0B, 0xE6, 0x34, 0x7B, 0xE4, 0xEB, 0x99, 0xC7, 0xC7 };
uint8 const ClientTypeSeed_Wn64[16] = { 0x2B, 0x05, 0xF6, 0xD7, 0x46, 0xC0, 0xC6, 0xCC, 0x7E, 0xF7, 0x94, 0x50, 0xB3, 0x09, 0xE5, 0x95 };
uint8 const ClientTypeSeed_Mc64[16] = { 0x91, 0x00, 0x36, 0x68, 0xC2, 0x45, 0xD1, 0x4E, 0xCD, 0x8D, 0xF0, 0x94, 0xE0, 0x65, 0xE0, 0x6B };
